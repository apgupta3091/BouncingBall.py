...
def main():
    ...
    #Set k and the sum=0 outside the loop
    k=0
    sum=0

    #Ask for the user input of the denominator as well as the number of terms
    den,terms=eval(input("Enter denominator and the number of terms:"))
    ...
    for i in range (1,(terms+1)):
        ...
        #Get the sum for each term and print every single one
        sum=serie+sum
        print(k,sum)
